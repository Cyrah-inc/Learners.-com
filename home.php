						...
						<div class="swiper-slide dark">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp">We are the Best</h2>
						...
						<div class="swiper-slide dark" style="background-image: url('images/slider/Slide1.jpg'); background-position: center top;">
							<div class="container clearfix">
								<div class="slider-caption">
									<h2 data-caption-animate="fadeInUp">We are Cyrah Inc</h2>
					...
					<div class="row clearfix">
						...
						<div class="col-lg-5">
							<div class="heading-block topmargin">
								<h1>Welcome to Cyrah INC <br>Programmers</h1>
							</div>
							<p class="lead">We are a group of excellent programmers; our aim is to provide the best web services for our clients. We design and develop functional and responsive web applications to help grow your business.</p>
						</div>
				...
				<div class="container clearfix" id="features">
					...
					<div class="row topmargin-lg bottommargin-sm">
						...
						<div class="heading-block center">
							...
							<span class="divcenter">Our team has many unique qualities &amp; skills. We design and develop quality web applications to suit the vast needs of our clients.</span>
						</div>
						...
						<div class="col-md-4 col-sm-6 bottommargin">
							...
							<div class="feature-box fbox-right topmargin" data-animate="fadeIn">
								...
								<h3>Qualified, Passionate developers</h3>
								<p>We have Exceptional Certified Professional developers to cater for your needs.</p>
							</div>
						...
						<div class="col-md-4 col-sm-6 bottommargin">
							...
							<div class="feature-box topmargin" data-animate="fadeIn">
								...
								<p>We provide well structured programming tutorials on YouTube.</p>
							</div>
							...
							<div class="feature-box topmargin" data-animate="fadeIn" data-delay="200">
								...
								<p>We are providing Endless Possibilities for everyone</p>
							</div>
