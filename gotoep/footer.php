		...
		<footer id="footer" class="dark">
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						<br>
						Copyrights &copy; 2022 All Rights Reserved by Cyrah Inc<br>
					...
					<div class="col_half col_last tright">
						...
						<i class="icon-envelope2"></i> cyrusgitau08@gmail.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> +254 720 012 365  <span class="middot"></span>
					</div>
